...
class FormComponent extends React.Component {
  ...
  validateField(name) {
    ...
    else if (name === "phoneCountryCode") isValid = this.validatePhoneCountryCode();
  ...
  validatePhoneCountryCode() {
    ...
    if (value.trim() === "") phoneCountryCodeError = "Phone Country Code is required";
      ...
      <div className="main">
        ...
        {this.state.isFormSubmitted ? (
          <div className="details">
            ...
            <div>Phone Number: {this.state.phoneCountryCode} {this.state.phoneNumber}</div>
